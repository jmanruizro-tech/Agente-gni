...
if not mi_api_key:
    st.error("⚠️ Error de configuración: No se encontró la GOOGLE_API_KEY en los Secrets de Streamlit.")
    st.stop()
...
# 4. Entrada de texto y Lógica del Chat
